...
const Sidebar = ({ openModal, socket }) => {
    ...
    return (
        <>
            <div className="hidden text-sm sm:flex flex-col h-full w-2/6 border-r">

                <div className="flex items-center justify-between border-b p-4">
                    <span className="mx-auto font-medium cursor-pointer"><span className='font-bold'>{user.name}</span> @{user.username}</span>
                ...
                <div className="flex flex-col overflow-y-auto overflow-x-hidden">
                    ...
                    <span className="px-4 py-4 font-medium">Messages</span>
